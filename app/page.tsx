    ...
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-muted/20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card className="border-2 hover:border-primary/50 transition-all hover:shadow-lg">
            <CardHeader>
              ...
              <CardTitle>Gráficos Visuais</CardTitle>
              <CardDescription>
          ...
          <Card className="border-2 hover:border-primary/50 transition-all hover:shadow-lg">
            <CardHeader>
              ...
              <CardTitle>Acesso em Qualquer Lugar</CardTitle>
              <CardDescription>
                Interface responsiva que funciona perfeitamente em desktop,
                tablet e mobile
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <div className="relative">
            ...
            <Card className="relative z-10">
              <CardHeader>
                ...
                <CardDescription>
                  Adicione suas receitas e despesas com categorias
                  personalizadas
                </CardDescription>
              </CardHeader>
            </Card>
          ...
          <div className="relative">
            <Card className="relative z-10">
              <CardHeader>
                ...
                <CardDescription>
                  Veja gráficos, receba insights e tome decisões financeiras
                  mais inteligentes
                </CardDescription>
              </CardHeader>
            </Card>
      ...
      >
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
            Descubra por que Techfin é a escolha perfeita para o controle
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card className="border-2 hover:border-primary/50 transition-all hover:shadow-lg">
            <CardHeader>
              ...
              <CardTitle>Facilidade de Uso</CardTitle>
              <CardDescription>
                Interface intuitiva e fácil de navegar, mesmo para iniciantes
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card className="border-2 hover:border-primary/50 transition-all hover:shadow-lg">
            <CardHeader>
              ...
              <CardDescription>
                Adapte o sistema às suas necessidades específicas com categorias
                personalizáveis
              </CardDescription>
            </CardHeader>
          </Card>
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-sm text-muted-foreground">
              © 2026 Techfin. Todos os direitos reservados.
            </p>
